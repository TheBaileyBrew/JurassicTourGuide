...
public class FragmentJurassicTwo extends Fragment implements View.OnClickListener{

    public static FragmentJurassicTwo newInstance() {
        FragmentJurassicTwo fragment = new FragmentJurassicTwo();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.jurassic_two, container, false);
